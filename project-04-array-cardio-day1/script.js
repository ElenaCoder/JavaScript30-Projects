...
const sortedInventorsFromOldestToYoungest = inventors.sort(
    (a, b) => a.year - b.year,
);
const sortedInventorsFromOldestToYoungest2 = inventors.sort((a, b) =>
    a.year > b.year ? 1 : -1,
...
const sortedPeople = people.sort((lastOne, nextOne) =>
    lastOne.split(',')[0] > nextOne.split(',')[0] ? 1 : -1,
);
console.log('Task7: ');
